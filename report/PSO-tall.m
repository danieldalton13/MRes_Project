...
movableNodesX = []; % Define indices of nodes that can move in x
movableNodesY = [11, 13, 15, 17]; % Define indices of nodes that can move in y
...
function stop = psoPlotFunction(optimValues, state, MovableNodeIndicesX, MovableNodeIndicesY, NODE, ELEM, SUPP, LOAD, BARS, ColTol, kappa, Cutoff, Ng)
    ...
    title(sprintf('Optimisation Process: Iteration %d', optimValues.iteration));
    drawnow;
end
