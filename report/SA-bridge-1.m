...
[NODE, ELEM, SUPP, LOAD, BARS] = StructDomain(8, 2, 8, 2, 'bridge', LoadNodes, LoadMagnitudes);
...
initialTemp = 20.0; % Increase initial temperature
coolingRate = 0.95; % Use a slower cooling rate
