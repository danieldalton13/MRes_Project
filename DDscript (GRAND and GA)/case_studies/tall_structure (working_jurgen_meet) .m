...
LoadNodes = [3, 5, 10, 13, 15];
LoadMagnitudes = [1, 1, 1, 1, 1];
LoadDirections = [1, 0; 1, 0; 0, 0; 1, 0; 1, 0]; % [x, y] directions for each load node

% Generate the structured orthogonal domain
[NODE, ELEM, SUPP, LOAD, BARS] = StructDomain(2, 4, 2, 5, 'bridge', LoadNodes, LoadMagnitudes, LoadDirections);
