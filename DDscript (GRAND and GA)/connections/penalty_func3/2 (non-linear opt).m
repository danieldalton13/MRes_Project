...
[~, ~, A, vol] = solveNonlinearStructure(NODE, BARS, SUPP, LOAD, kappa);
...
function [cost, exitflag, A, vol] = solveNonlinearStructure(NODE, BARS, SUPP, LOAD, kappa)
    try
        ...
        options = optimoptions('fmincon', 'Algorithm', 'interior-point', 'Display', 'off'); % Change algorithm
