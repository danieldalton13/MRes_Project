...
TolY = 0.5; % Tolerance for node movement in y
...
crossoverRate = 0.8; % Example crossover rate defined by the user
mutationRate = 0.01; % Example mutation rate defined by the user
...
options = optimoptions('ga', ...
    ...
    'MaxGenerations', 100, ... 
    'Display', 'iter', ...
    'CrossoverFraction', crossoverRate, ... % Setting the crossover rate
    'MutationFcn', {@mutationuniform, mutationRate}, ... % Setting the mutation rate
